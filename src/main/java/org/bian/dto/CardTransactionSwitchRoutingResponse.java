...
/**
 * CardTransactionSwitchRoutingResponse
 */
public class CardTransactionSwitchRoutingResponse   {
  private String cardTransactionSwitchOperatingSessionReference = null;

  private String cardTransactionSwitchRoutingTaskReference = null;
  ...
  private Object cardTransactionSwitchRoutingTaskRecord = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier general-info: \"refers to the transaction routing task within the switch operating session\" 
   * @return cardTransactionSwitchRoutingTaskReference
  **/

  public String getCardTransactionSwitchRoutingTaskReference() {
    return cardTransactionSwitchRoutingTaskReference;
  }

  public void setCardTransactionSwitchRoutingTaskReference(String cardTransactionSwitchRoutingTaskReference) {
    this.cardTransactionSwitchRoutingTaskReference = cardTransactionSwitchRoutingTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier general-info: \"refers to the card transaction as recorded by issuer and/or acquirer - these may be batched\" 
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary general-info: \"processing record of the Network, Issuer and Acquirer card routing task\" 
   * @return cardTransactionSwitchRoutingTaskRecord
  **/

  public Object getCardTransactionSwitchRoutingTaskRecord() {
    return cardTransactionSwitchRoutingTaskRecord;
  }

  public void setCardTransactionSwitchRoutingTaskRecord(Object cardTransactionSwitchRoutingTaskRecord) {
    this.cardTransactionSwitchRoutingTaskRecord = cardTransactionSwitchRoutingTaskRecord;
  }
